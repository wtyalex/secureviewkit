...
public class SwipeItemLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        measureChildWithMargins(mainItemView, widthMeasureSpec, getPaddingLeft() + getPaddingRight(), heightMeasureSpec,
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mainItemView.layout(pl + lp.leftMargin, pt + lp.topMargin, getWidth() - pr - lp.rightMargin,
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            menuView.layout(tempLeft, tempTop, tempLeft + menuView.getMeasuredWidth() + lp.rightMargin,
